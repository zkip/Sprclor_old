...
_.extend(ZUI, {
    ...
    SetTranslateMatrix: function (m, x, y) {
        m.elements[2] = x;
        m.elements[5] = y;
        return m;
    },
...
_.extend(ZUI.prototype, {
    ...
    zoomSet: function (zoom, clientX, clientY) {
        ...
        var dx = clientX - c.x;
        var dy = clientY - c.y;
        ZUI.TranslateMatrix(this.surfaceMatrix, dx, dy);
        this.updateSurface();
        return this;
    },
    moveBy: function (dx,dy){
        // this.surfaceToClient(dx,dy);
        this.translateSurface(dx, dy);
        this.updateSurface();
        return this;
    },
    moveTo: function (x,y){
        ZUI.SetTranslateMatrix(this.surfaceMatrix, x, y);
        this.updateSurface();
        return this;
    },
    getTransition(){
    ...
    updateOffset: function () {
        ...
        this.viewportOffset.bound=rect;
        this.viewportOffset.bound.left -= document.body.scrollLeft;
        this.viewportOffset.bound.top -= document.body.scrollTop;
        this.viewportOffset.matrix
            .identity()
            .translate(this.viewportOffset.bound.left, this.viewportOffset.bound.top);
        return this;
    },
